class Point {
  ...
  translate(ox: number, oy:number) : Point {
		// TODO create a new Point translated of (x, y)
    const isPOint = new Point(this.x + ox, this.y + oy);
    return isPOint;
  }
}
...
class Line {
  ...
  translate(ix: number, iy:number) : Line {
   ...
   return new Line(this.point1 = ix, this.point1 = iy, this.point2 = ix, this.point2 = iy),this.color;  }
